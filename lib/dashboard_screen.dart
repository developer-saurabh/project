...
//           children: [
//             Text("Rajiv Gandhi College", style: TextStyle(fontSize: 16)),
//             Text("Research and Technology", style: TextStyle(fontSize: 12)),
//           ],
//         ),
//         actions: [
...
//               child: ClipRRect(
//                 borderRadius: BorderRadius.circular(12),
//                 child: Image.network('assets/image.jpg', fit: BoxFit.cover),
//               ),
//             ),
